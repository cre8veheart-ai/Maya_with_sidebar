...
const requiredRegistryMarkers = [
  'id: "maya.cto.v1"', 'id: "maya.cmo.max.v2"', 'memoryNamespace: "executive/cto"', 'memoryNamespace: "executive/cmo"',
...
const requiredRuntimeMarkers = [
  "validateExecutiveModule", 'mode === "live"', "human approval required for action", "remote reasoning never inherits MAYA policy", "sandbox/preview results are not production verification",
];
