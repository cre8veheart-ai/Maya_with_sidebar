    ...
    <div className="min-h-full w-full min-w-0 max-w-5xl overflow-x-hidden px-1 py-3 pb-[max(6rem,env(safe-area-inset-bottom))] sm:px-4 sm:py-6 sm:pb-6 lg:px-8 lg:py-10 lg:pb-10">
      <div className="flex min-w-0 items-start justify-between gap-3 mb-4 sm:mb-8">
        <div className="min-w-0">
          <h1
            className="text-[30px] font-black text-[#16223b] tracking-tight leading-tight font-[var(--font-playfair)]"
            style={{ textShadow: "0 1px 0 #ffffff, 0 2px 0 rgba(15, 23, 42, 0.16), 0 10px 24px rgba(15, 23, 42, 0.08)" }}
          >
            <span className="font-[var(--font-playfair)] float-left mr-1.5 mt-0.5 text-[44px] leading-[0.85] text-[#0f172a]">{first}</span>
            <span className="font-[var(--font-playfair)]">{rest}</span>
          </h1>
          {subtitle && (
