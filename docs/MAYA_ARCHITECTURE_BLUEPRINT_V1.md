# MAYA Architecture Blueprint V1

Owner: Leslie, Founder of RAIN™ and MAYA.

## Purpose

This blueprint describes MAYA's product architecture: its menu, user-facing workspaces, executive modules, shared services, persistence, Client Vaults, integrations, and build sequence.

It does **not** define repository policy, security permissions, agent authority, GitHub approvals, Vercel access, branch protection, secrets, or deployment rights. Those are implemented only through the relevant platform settings and code.

## Product identity

MAYA is an Executive Operating System and Pocket Office—not a generic chatbot. MAYA coordinates specialized executives, preserves separate client workspaces, supports durable sessions and documents, and keeps consequential external actions under human control.

## Primary menu and workspace map

- **Home / Max CEO** — founder-facing executive conversation and decision surface.
- **Executive Suite** — CEO, CFO, CMO, CTO and later specialist executives with role-isolated reasoning.
- **Strategy Room** — multi-executive analysis, disagreement, comparison and adjudication.
- **Client Vaults** — separate client workspaces with explicit identity, access and zero-provider-access design.
- **Library** — saved sessions, reports, documents, publications and reusable company knowledge.
- **White Boardroom** — presentations, campaign work, creative production and shared visual collaboration.
- **Workflows and Decisions** — structured plans, evidence, owners, deadlines, approvals and outcome tracking.
- **Settings** — MAYA sign-in, workspace preferences, integrations and user-controlled configuration.

## Architectural boundaries

- One MAYA sign-in; executive personas do not require separate sign-ins.
- Client data remains separated by client/workspace.
- Provider credentials and secrets remain server-side.
- External actions require clear human approval.
- Product features must work on phone, tablet and desktop.
- Architecture descriptions do not create GitHub or Vercel controls.
