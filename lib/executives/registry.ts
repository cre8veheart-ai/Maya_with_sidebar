...
export const MAYA_AGENTS: MayaAgent[] = [
  ...
  },
  {
    ...
    layer: "executive",
    mission: "Own market intelligence, positioning, brand, customer strategy, growth, campaigns, and commercial creative direction.",
    owns: ["brand", "gtm", "segmentation", "campaigns", "growth", "customer intelligence", "creative direction"],
